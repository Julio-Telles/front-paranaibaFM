...
const nextConfig: NextConfig = {
  devIndicators: false,//SE "true" OU A KEY 'devIndicators' NÃO FOR EXPLICITADA AQUI, FICARÁ APARECENDO UM ÍCONE NA PARTE DEBAIXO À ESQUERDA SOBRE O STATUS DA ROUTE (STATIC OU DYNAMIC)
